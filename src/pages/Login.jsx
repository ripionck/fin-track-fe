import { Eye, EyeOff, Lock, Mail, Menu, MessageSquare } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#1e2e42] flex items-center justify-center p-4">
      <div className="bg-white rounded-lg p-8 w-full max-w-md">
        <div className="flex justify-between items-center mb-8">
          ...
          <MessageSquare className="w-6 h-6 text-[#1e2e42]" />
        </div>

        <h1 className="text-2xl text-[#1e2e42] font-bold text-center mb-2">
          Login
        </h1>
        ...
        <form className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-[#1e2e42] hover:bg-[#1e2e42] text-white py-3 rounded-full"
          >
            Sign in
          </button>
        </form>
